...
const projects: {
...
}[] = [
    {
        ...
        description:
            "A production-ready, full-stack e-commerce platform built with the MERN stack. Features JWT authentication with refresh tokens, shopping cart, Stripe payments, coupon system, admin analytics dashboard with sales charts, Redis caching, and Cloudinary image uploads.",
        tags: [
            "React",
            "Node.js",
            "Express",
        ...
        githubUrl: "https://github.com/Navin-MS-data/shop-sphere",
        liveUrl: "https://shop-sphere-1fzm.onrender.com/",
    },
    {
        title: "CRWN Clothing",
