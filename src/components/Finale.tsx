        ...
        <section className="relative w-full bg-white border-t-8 border-black pt-10 overflow-hidden">
            <div className="max-w-6xl mx-auto px-6 py-20 flex flex-col items-center">
                ...
                <div className="relative mb-20 text-center">
                    <h2 className="text-[12vw] md:text-[8vw] font-black uppercase leading-none tracking-tighter text-black/5 absolute -top-8 sm:-top-1/2 left-1/2 -translate-x-1/2 select-none pointer-events-none">
                        THANK YOU
                    </h2>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full mb-24">
                    {socialLinks.map((link) => (
                        <a
                            ...
                            className="group flex flex-col items-center justify-center p-5 sm:p-8 border-2 border-black bg-white hover:bg-black transition-all duration-300 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px]"
                        >
