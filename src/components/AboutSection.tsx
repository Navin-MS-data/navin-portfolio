    ...
    <SectionBlock id="about" title="About me">
        <div className="space-y-10">
            ...
            <p className="text-foreground/80 text-lg md:text-xl leading-relaxed max-w-3xl font-light">
                Passionate Full Stack Developer eager to begin a career in web
                development. Proficient in key frontend and backend technologies
                and passionate about creating seamless user experiences.
            </p>

            {/* Supporting text */}
            <p className="body-text max-w-2xl">
                Ready to collaborate and learn, contributing to innovative web
                applications and applying strong organizational and
