...
const HeroSection = () => {
    ...
    useEffect(() => {
        ...
        if (!isDeleting && displayedRole === currentRole) {
            ...
            const t = setTimeout(() => setIsDeleting(true), pauseBeforeDelete);
            return () => clearTimeout(t);
        }
        ...
        `}
            ...
            `}
                    >
                        ...
                        <span className="font-mono text-base md:text-lg tracking-[0.1em] text-foreground font-semibold min-w-[2ch]">
                            {displayedRole}
                            <span className="inline-block w-[2px] h-[1em] bg-foreground align-middle ml-0.5 animate-pulse" />
                        </span>
                        <span className="font-mono text-base md:text-lg tracking-[0.2em] text-foreground/40">
                            {" />"}
                        </span>
            ...
            `}
                    >
                        ...
                        from clean UI design to smooth user interactions and
                        scalable code.
                    </p>
